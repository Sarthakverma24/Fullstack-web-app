...
func (x *UserRequest) GetGmail() string {
	if x != nil {
		return x.Gmail
	}
	return ""
...
const file_user_proto_rawDesc = "" +
	...
	"\x05gmail\x18\x02 \x01(\tR\x05gmail\"(\n" +
	"\fUserResponse\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage2>\n" +
	"\vUserService\x12/\n" +
	"\x06SignIn\x12\x11.user.UserRequest\x1a\x12.user.UserResponseB\"Z awesomeProject/signin/proto;userb\x06proto3"
...
var file_user_proto_depIdxs = []int32{
	0, // 0: user.UserService.SignIn:input_type -> user.UserRequest
	1, // 1: user.UserService.SignIn:output_type -> user.UserResponse
